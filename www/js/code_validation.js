App.controller('ValidationCtrl',function($scope,$state,$stateParams,$ionicLoading,$http,$ionicPopover,$ionicPopup,$rootScope,Restangular){
    $scope.$on('$ionicView.enter', function(e) {
        ...
        $scope.validation = function () {
            ...
            if($scope.code_validation == $rootScope.code_validation){
